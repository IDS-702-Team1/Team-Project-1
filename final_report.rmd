...
The baseline values incorporated in the intercept are treat=0,black=0,hispan = 0,age = 27, and married=0. Keeping other things constant, for an unmarried, non-black, non-hispanic, non-trainee, with an age of about 27, and education of about 10 years would earn 1743$.
...
1) Linearity: The residual versus predictor plot seems random for the variable "age", while the other predictors are categorical.
